    ...
    <aside class="w-full md:w-64">
        <div class="md:hidden mb-4">
            <button
                    type="button"
                    id="filterToggle"
                    class="w-full bg-white border border-slate-200 shadow-sm rounded-2xl px-4 py-4 font-extrabold text-xs uppercase text-slate-700 flex items-center justify-between"
            >
        ...
        <div id="filterPanel" class="hidden md:block">
                ...
                <div class="mb-6">
                    ...
                    <?php foreach(['sk'=>'🇸🇰 SK','cz'=>'🇨🇿 CZ','pl'=>'🇵🇱 PL'] as $c=>$n): ?>
                        <label class="flex items-center gap-2 mb-2">
                            ...
                            <span class="text-sm font-bold text-slate-600"><?php echo $n; ?></span>
                        </label>
                    <?php endforeach; ?>
                </div>
                    ...
                    <?php foreach($allTags as $tag): ?>
                        <label class="flex items-center gap-2 mb-2 group cursor-pointer">
                            <input type="checkbox" name="tags[]" value="<?php echo h($tag['code']); ?>"
                                   ...
                                   class="rounded text-lec-teal">
                            <span class="text-sm font-bold text-slate-600 group-hover:text-lec-teal transition">
                                    <i class="fa <?php echo h($tag['icon']); ?> w-4 text-center opacity-50 mr-1"></i>
        ...
        <div class="flex flex-wrap gap-2 justify-center mb-8">
            ...
            <?php foreach($categories as $c): ?>
                <label class="cursor-pointer">
                    ...
                    <div class="px-4 py-2 rounded-full border border-slate-200 text-[10px] font-bold uppercase peer-checked:bg-lec-dark peer-checked:text-white bg-white text-slate-500">
