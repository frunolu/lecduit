...
// --- 1. DETEKCE TRHU A MĚNY (Podle domény) ---
$market = [
    'id'        => 'sk',
    'currency'  => '€',
    'price_col' => 'price_sk',
...
if (strpos($host, 'lecduit.cz') !== false) {
    ...
    // Pro celoevropskou doménu používáme Euro a angličtinu
    $market = ['id' => 'eu', 'currency' => '€', 'price_col' => 'price_sk', 'def_lang' => 'en'];
}

// --- 2. LOGIKA JAZYKA (Session + GET přepínač) ---
if (isset($_GET['lang'])) {
...
// --- 3. KOMPLETNÍ PŘEKLADOVÝ SLOVNÍK (UI Texty) ---
$txt = [
    'sk' => [
...
// --- 4. GLOBÁLNÍ PROMĚNNÉ PRO SQL A ŠABLONY ---
$market_id = $market['id'];
...
/**
 * Formátuje cenu dle trhu a měny
 */
