...
<body class="bg-slate-50 text-slate-900 font-sans antialiased">
    ...
    <header class="bg-white border-b sticky top-0 z-40">
        <div class="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <a href="index.php" class="text-xs font-bold uppercase text-slate-400 hover:text-lec-teal transition">← <?php echo $t['back']; ?></a>
        </div>
    </header>
                    ...
                    <form action="checkout.php" method="POST" class="space-y-6">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="first_name" required class="w-full bg-slate-50 border-0 rounded-2xl px-4 py-3 font-bold focus:ring-2 focus:ring-lec-teal outline-none transition">
                            </div>
                            <div>
                                <label class="text-[10px] font-bold uppercase text-slate-400 ml-2"><?php echo $t['l_name']; ?></label>
                                <input type="text" name="last_name" required class="w-full bg-slate-50 border-0 rounded-2xl px-4 py-3 font-bold focus:ring-2 focus:ring-lec-teal outline-none transition">
                            </div>
                        </div>
                        <div>
                            <label class="text-[10px] font-bold uppercase text-slate-400 ml-2"><?php echo $t['email']; ?></label>
                            <input type="email" name="email" required class="w-full bg-slate-50 border-0 rounded-2xl px-4 py-3 font-bold focus:ring-2 focus:ring-lec-teal outline-none transition">
                        </div>
                        <div>
